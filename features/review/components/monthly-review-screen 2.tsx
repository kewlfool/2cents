...
function SummaryMetric(props: {
  ...
  return (
    <div className="border-line/70 bg-panel/96 space-y-0.5 rounded-lg border px-3.5 py-2.5">
    ...
    <div className="space-y-5 print:space-y-4">
      ...
      <section className="grid gap-4 xl:grid-cols-[1.4fr_0.9fr]">
        <Card variant="elevated">
          <CardHeader density="compact" divider>
          ...
          <Card variant="muted">
            ...
            <CardContent className="space-y-3">
              {reviewDetail.overBudgetCategories.length === 0 ? (
                <div className="border-line/70 bg-panel text-muted rounded-lg border px-3.5 py-3 text-sm leading-5">
                  No expense categories were over budget this month.
                </div>
              ) : (
                <>
                  <div className="border-line/70 bg-panel rounded-lg border px-3.5 py-3">
                    <p className="text-muted text-sm">Total overspend</p>
                    <p className="text-warning mt-1.5 text-xl font-semibold tracking-tight">
    ...
    <>
      ...
      {isExpanded ? (
        <tr className="print:table-row">
          <td className="bg-panel-strong/20 px-4 py-3.5" colSpan={5}>
            {transactions.length === 0 ? (
              <div className="text-muted rounded-lg bg-white/35 px-3.5 py-3 text-sm leading-5">
